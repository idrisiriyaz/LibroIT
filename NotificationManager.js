...
class NotificationManagerCode {
	...
	showNotification = (sbText, Title, Msg, Url, userProfile) => PushNotification.localNotification({
		...
		subText: sbText, // (optional) default: none
		...
		// tag: "Hiii", // (optional) add tag to message
...
const NotificationManager = new NotificationManagerCode();
